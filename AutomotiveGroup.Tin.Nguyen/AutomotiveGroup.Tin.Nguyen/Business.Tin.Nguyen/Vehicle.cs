...
namespace Business.Tin.Nguyen
{
    ...
    public class Vehicle
    {
        ...
        /// contain less than 0 non-whitespace characters.
        /// </exception>
        public Vehicle(int year, string model, string manufacturer, PaintColor color, decimal salePrice)
        {   
            if (year < 1950 || year > 2024)
            {
                throw new ArgumentOutOfRangeException("year", "The year must be in the range of 1950 to 2024.");
            }
            ...
            if (salePrice < 0)
            {
                throw new ArgumentOutOfRangeException("The salePrice must be 0 or greater.", "salePrice");
            }
